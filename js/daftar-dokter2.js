        ...
        dokters.forEach((element) => {
            let cardDokter = `
                <div class="w-80 h-auto inline-block m-5">
                    <img src="https://images.unsplash.com/photo-1537368910025-700350fe46c7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80" alt="Dokter Anak" class="rounded-xl" />
                    <div class="mt-1.5">
